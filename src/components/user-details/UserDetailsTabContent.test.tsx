...
import UserDetailsTabContent from "./UserDetailsTabContent";

jest.mock("./tabs-sections/AppSystem", () => ({
  __esModule: true,
  default: () => <div data-testid="app-system-tab">AppAndSystem Tab</div>,
}));
jest.mock("./tabs-sections/BankDetails", () => ({
  __esModule: true,
...
jest.mock("./tabs-sections/GeneralDetails", () => ({
  __esModule: true,
  default: () => (

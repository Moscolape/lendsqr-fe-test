...
import UserDetailsHeader from "../../components/user-details/UserDetailsHeaders";
import UserDetailsTabContent from "../../components/user-details/UserDetailsTabContent";
